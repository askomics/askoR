...
rm(list=ls())
source("/<path_where_your_askoR_is>/AskoR.R")
...
#--------------------------------------------------------------------------
parameters$analysis_name = "DEG_test"                 # output directory name (default DE_analysis, do not put space!)
# parameters$analysis_name = "DEG_Countsfiles_complet"  # output directory name (default DE_analysis, do not put space!)
# parameters$analysis_name = "DEG_Countsfiles_delAC3R2" # output directory name (default DE_analysis, do not put space!)
...
# parameters$sample_file = "Samples_CountsFiles.txt"    # file describing the samples
# parameters$col_genes = 1                              # column with the gene names (default 1) in the counting matrix or count files
# parameters$col_counts = 7                             # col of counts in count files (default 7)
...
parameters$mean_counts = F                            # Mean counts in the summary table (default TRUE)
parameters$norm_counts = F                            # Generate files with mormalized counts
