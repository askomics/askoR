...
Asko_start <-function(){
  ...
  option_list = list(
    ...
    make_option(c("-g", "--col_genes"), type="integer", default=NULL, dest="col_genes",
                help="col of ids in count files [default= %default]", metavar="integer"),
    make_option(c("-C", "--col_counts"), type="integer", default=NULL,dest="col_counts",
    ...
    make_option(c("--th_FDR", "--threshold_FDR"), type="double", default=0.05, dest="threshold_FDR",
